...
| [`Decoder.Encoder`](https://pkg.go.dev/github.com/jecoms/regextra/v2#Decoder.Encoder) / [`Decoder.MustEncoder`](https://pkg.go.dev/github.com/jecoms/regextra/v2#Decoder.MustEncoder) / [`Encoder.Encode`](https://pkg.go.dev/github.com/jecoms/regextra/v2#Encoder.Encode) | Derive an [`Encoder[T]`](https://pkg.go.dev/github.com/jecoms/regextra/v2#Encoder) — the typed inverse built by inverting the decoder's own pattern (`MustEncoder` panics, for package-level vars) — and render a struct back into a string |
